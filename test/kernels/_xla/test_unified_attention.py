...
from ejkernel.kernels._xla import unified_attention
...
def test_unified_attention_xla_matches_reference_basic():
    batch = _make_inputs(
        rng_seed=0,
        num_seqs=2,
        num_q_heads=8,
...
def test_unified_attention_xla_features_sliding_softcap_sinks_alibi_qqbias():
    batch = _make_inputs(
        rng_seed=1,
        num_seqs=3,
        num_q_heads=8,
