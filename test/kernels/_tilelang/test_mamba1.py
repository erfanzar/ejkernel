...
"""TileLang parity tests for mamba1."""
...
from ._helpers import _SEED, _max_abs, _state_space_v1_inputs, _tl, _xla


def test_mamba1_fwd_bwd():
    args = _state_space_v1_inputs(_SEED + 51)
    tl, xla = _tl("mamba1"), _xla("mamba1")
