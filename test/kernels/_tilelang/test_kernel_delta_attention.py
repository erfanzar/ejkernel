...
"""TileLang parity tests for kernel_delta_attention."""
...
def test_kernel_delta_attention_fwd_bwd():
    ...
    tl, xla = _tl("kernel_delta_attention"), _xla("kernel_delta_attention")
    o_tl, sf_tl = tl(q, k, v, beta, decay, **kwargs)
    o_x, sf_x = xla(q, k, v, beta, decay, **kwargs)
