...
"""TileLang parity tests for multi_latent_ragged_page_attention."""
...
def test_multi_latent_ragged_page_attention_native():
    args = _make_mla_ragged_inputs()
    (
        queries_nope,
        queries_pe,
        keys_values,
    ...
    out_xla, cache_xla = _xla("multi_latent_ragged_page_attention")(
        common[0], common[1], common[2], common[3], kv_cache.copy(), *common[4:], **kwargs
    )
    out_tl, cache_tl = _tl("multi_latent_ragged_page_attention")(
        common[0], common[1], common[2], common[3], kv_cache.copy(), *common[4:], **kwargs
    )
