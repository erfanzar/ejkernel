...
"""TileLang parity tests for grouped_matmulv2."""
...
_ALGORITHM = "grouped_matmulv2"


@pytest.mark.parametrize("transpose_rhs", [False, True])
def test_grouped_matmulv2_parity(transpose_rhs):
    M, K, N = 64, 32, 16
    num_groups = 4
...
def test_grouped_matmulv2_group_offset():
    K, N = 16, 12
